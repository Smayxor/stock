...
def drawGEXChart(ticker, count, dte, chartType = 0, strikes = None, expDate = 0, price = 0, RAM=False):
	...
	#maxABSGEX = max(strikes, key=lambda i: i[dp.GEX_ABS_GEX])[dp.GEX_ABS_GEX] #Non-existant from datapuller.py generated by this method
	...
	for strike in strikes :
		...
		#if (strike[dp.GEX_ABS_GEX] != 0) : drawRect(draw, 295, x, 295 + ((strike[dp.GEX_ABS_GEX] / maxABSGEX) * 150), x + 12, color="#00f", border='')
...
def drawPriceChart(ticker, fileName, gexData, userArgs, includePrices = False, RAM=False, deadprice=0.25, timeMinute=630):
	...
	for j in range(lenDisplays):
		...
		drawText( draw, preIndex, y, txt=txt, color='blue', anchor="rt")
